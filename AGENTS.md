...
**Note:** The upstream CLI binary/package is still named `clawdbot`. This repo creates an `openclaw` wrapper symlink inside the container so user-facing commands can use `openclaw`.
